...
import {
  useFetchAPILesson,
  useFetchAPILessonByUser,
} from "../../../hook/useFetchAPILesson.jsx";
...
const DropdownButton = ({ idLesson }) => {
  ...
  const buttonItems = [
    {
      ...
      direction: `/startGame/${idLesson}`,
    },
    { label: "Xem trước", iconClass: "far fa-play", direction: `/preview_lesson/${idLesson}` },
  ];
  ...
  return (
    <div className="relative">
      ...
      {isDropdownOpen && (
        <div className="absolute z-50 left-0 mt-2 bg-light-3 shadow-soft-high rounded w-45">
...
const CreateByMe = () => {
  ...
  // console.log(allLessonByUser);
  return (
    <div className="flex flex-col p-4">
      {allLessonByUser?.map((item, index) => {
        return (
          <div className="flex flex-col gap-y-1 pb-12" key={index}>
