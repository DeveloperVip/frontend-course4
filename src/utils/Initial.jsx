export const initialAnswers = [
    { id: 1, 
      content: "", secure_url: null, isTrue: false ,public_id:null},
    { id: 2, 
      content: "", secure_url: null, isTrue: false ,public_id:null},
    { id: 3, 
      content: "", secure_url: null, isTrue: false ,public_id:null},
...
export const dateOptions = [
 ...
 export const subjects = [
  { name: 'Toán học', description: 'Môn học về các khái niệm và phương pháp toán học' },
  ...
  { name: 'Lý học', description: 'Môn học về các hiện tượng và định lý vật lý' },
  { name: 'Sinh học', description: 'Môn học về sinh vật và các quá trình sinh học' },
  { name: 'Lịch sử', description: 'Môn học về các sự kiện và nhân vật lịch sử' },
  { name: 'Địa lý', description: 'Môn học về các hiện tượng và đặc điểm địa lý' },
];

export const visibility = [
  {
    name: 'Cộng đồng',
    description: 'This activity will be publicly visible in the quizizz library',
    icon: true, // Ví dụ về tùy chọn có biểu tượng
    selected: true,
  },
  {
    name: 'Hạn chế',
    description: 'This activity will be visible only by you and the people you share this with',
    icon: true,
    selected: false,
  },
  {
    name: 'Mọi người trong tổ chức',
    description: 'This activity will be visible only by teachers in Sở Giáo Dục Hà Nội',
    icon: true,
    selected: false,
  },
];
...
export const grades = [
  ...
  { name: 'Lớp 10', description: 'Năm học đầu tiên của cấp trung học phổ thông' },
  { name: 'Lớp 11', description: 'Năm học thứ hai của cấp trung học phổ thông' },
  { name: 'Lớp 12', description: 'Năm học cuối cùng của cấp trung học phổ thông' },
  { name: 'Đại học', description: 'Bậc học đại học' },
  { name: 'Sau đại học', description: 'Chương trình học sau khi tốt nghiệp đại học' },
  { name: 'Đào tạo nghề', description: 'Chương trình học nghề và kỹ năng chuyên môn' },
];
